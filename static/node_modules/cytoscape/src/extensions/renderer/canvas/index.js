...
function CanvasRenderer( options ){
  ...
  for( var i = 0; i < CRp.CANVAS_LAYERS; i++ ){
    var canvas = r.data.canvases[ i ] = document.createElement( pageEnum.CANVAS );  // eslint-disable-line no-undef
  ...
  for( var i = 0; i < CRp.BUFFER_COUNT; i++ ){
    r.data.bufferCanvases[ i ] = document.createElement( pageEnum.CANVAS );  // eslint-disable-line no-undef
